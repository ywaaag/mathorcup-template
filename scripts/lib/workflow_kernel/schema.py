...
TEMPLATE_SOURCE_REQUIRED_FILES = [
    ...
    "scaffold/project/runtime/worker_pool.json.template",
    ...
    "scaffold/project/paper/cumcmthesis.cls",
    "scaffold/project/paper/metadata.tex",
    "scaffold/project/paper/main.tex",
    ...
    ".codex/agents/code_brain.toml",
    ".codex/agents/paper_brain.toml",
    ".codex/agents/layout_worker.toml",
    ".codex/agents/utility_worker.toml",
    ".codex/agents/review_worker.toml",
    ".codex/agents/citation_worker.toml",
    ...
    "scaffold/.codex/agents/code_brain.toml",
    "scaffold/.codex/agents/paper_brain.toml",
    "scaffold/.codex/agents/layout_worker.toml",
    "scaffold/.codex/agents/utility_worker.toml",
    "scaffold/.codex/agents/review_worker.toml",
    "scaffold/.codex/agents/citation_worker.toml",
